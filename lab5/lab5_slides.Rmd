...
```{r, echo=F}
knitr::include_graphics("chris_examples/plot/iverScatter.pdf")
```

## Expected probabilities and first differences: Voting example
```{r, echo=F}
knitr::include_graphics("chris_examples/plot/educationEV.pdf")
```
...
## Expected probabilities and first differences: Voting example
```{r, echo=F}
knitr::include_graphics("chris_examples/plot/marriedEV.pdf")
```

## Expected probabilities and first differences: Voting example
```{r, echo=F}
knitr::include_graphics("chris_examples/plot/marriedFDRR.pdf")
```

## Ropeladder: Crime example (if time permits)
```{r, echo=F}
knitr::include_graphics("chris_examples/plot/ropeladderEx0.pdf")
```

## Ropeladder: Crime example (if time permits)
```{r, echo=F}
knitr::include_graphics("chris_examples/plot/ropeladderEx1.pdf")
```

## 
```{r, echo=F, fig.height=0.5}
knitr::include_graphics("chris_examples/plot/ropeladderEx2.pdf")
```

## Ropeladder: Crime example (if time permits)
```{r, echo=F}
knitr::include_graphics("chris_examples/plot/ropeladderEx3.pdf")
```
