...
subtitle: "Lab 2: Intro to \\LaTeX{} with \\texttt{Overleaf}"
author: "Kenya Amano"
...
# `RMarkdown` and HW1
- Problem 1: Attach file (PDF/picture) and make comments with 2-5 paragraphs

- Problem 2: Read data and display the plot
  - *Do not spend more than two hours* 


# Intro to \TeX{} and \LaTeX{}
- \TeX{} is a *typesetting engine*^[\scriptsize Modern extensions of the \TeX{} engines include pdfTeX, XeTeX, LuaTeX, etc.] designed by Donald Knuth, a computer scientist and mathematician at Stanford
...
- Some useful templates:
  ...
  - Working paper: \href{https://www.overleaf.com/read/qgpdhyztkpgt
}{My sample}, and \href{https://www.overleaf.com/project/5e42e4a9ae15f200014a4919}{Chris's sample}
